...
export default function FeatureBar() {
  return (
    <div className="home-hero-featurebar cursor-default">
      
      <div className="home-hero-featurebar-item group">
        <img src={LN1} className="home-hero-featurebar-icon group-hover:animate-spin" alt="" />
      ...
      <div className="home-hero-featurebar-item group">
        <img src={LN2} className="home-hero-featurebar-icon group-hover:animate-spin" alt="" />
      ...
      <div className="home-hero-featurebar-item group">
        <img src={LN3} className="home-hero-featurebar-icon group-hover:animate-spin" alt="" />
      ...
      <div className="home-hero-featurebar-item group">
        <img src={LN4} className="home-hero-featurebar-icon group-hover:animate-spin" alt="" />
