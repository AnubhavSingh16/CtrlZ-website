...
export default function GetStarted({ data }) {
 ...
 const validate = () => {
  ...
  return (
    <>
      <section className="w-full bg-gradient-to-br from-black via-[#0d021b] to-black py-12 md:py-12 sm:py-10 lg:py-16 px-4 sm:px-6 group">
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-4 bg-[#A66CFF] hover:bg-[#8f56e8] text-white font-semibold py-3 rounded-lg group-hover:animate-bounce"
                >
